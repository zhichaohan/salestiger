              ...
              <div className="row">
                <div className="col-lg-12">
                  <div>
                    ...
                    <h4 id="section-1">Interpretation and Definitions</h4>
                    ...
                    <ul className={styles.unordered_list}>
                      ...
                      <li>
                        <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Sales Tiger, 9778 Caminito Doha San Diego CA 92131.
                      </li>
                      <li>
                      ...
                      <li>
                        <strong>Website</strong> refers to Sales Tiger, accessible from <a href="https://www.salestiger.io" rel="external nofollow noopener" target="_blank">https://www.salestiger.io</a>
                      </li>
                      <li>
                    ...
                    <h4 id="section-2">Collecting and Using Your Personal Data</h4>
                    ...
                    <ul className={styles.unordered_list}>
                      ...
                      <li><strong>To contact You:</strong> To contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication, such as a mobile application's push notifications regarding updates or informative
                      ...
                      <li><strong>To provide You</strong> with news, special offers and general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless You have
                          opted not to receive such information.
                      </li>
                      <li><strong>To manage Your requests:</strong> To attend and manage Your requests to Us.
                      </li>
                      <li><strong>For business transfers:</strong> We may use Your information to evaluate or conduct a merger, divestiture, restructuring, reorganization, dissolution, or other sale or transfer of some or all of Our assets, whether as a
                      ...
                      <li><strong>For other purposes</strong>: We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our
                    ...
                    <ul>
                      <li>By email: <a href="mailto:zhichao@salestiger.io">zhichao@salestiger.io</a></li>
                    </ul>
                  </div>
                </div>
              </div>
